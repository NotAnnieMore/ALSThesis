...
\begin{table}[htbp]
  \centering
  \caption[Pairwise Wilcoxon tests with Bonferroni correction]{Pairwise Wilcoxon signed-rank tests with Bonferroni correction (Friedman $\chi^2 = 12.43$, $p = 0.0531$).}
