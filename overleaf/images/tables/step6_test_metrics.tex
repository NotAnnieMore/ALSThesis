\begin{table}[ht]
\centering
\caption{Held-out TEST set metrics (6-month horizon, $n=279$). Models were fitted on DEV only. PR-AUC and ROC-AUC are threshold-free; F$_1$ and F$_2$ are evaluated at the default $t=0.50$; the Brier score measures probabilistic error (lower is better).}
